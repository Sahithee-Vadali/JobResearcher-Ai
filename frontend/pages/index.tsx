...
import { Search, TrendingUp, Users, MapPin, DollarSign, Clock, CheckCircle, AlertCircle, Linkedin } from 'lucide-react';
    ...
    const poll = async () => {
      try {
        ...
        if (status.status === 'completed') {
          ...
          setResults(results);
          setIsLoading(false);
          toast.success('Research completed successfully!', { duration: 3000, icon: '✅' });
          return;
        }
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {/* Results */}
          {results && !isLoading && <ResearchResults results={results} searchData={searchData} />}
          ...
          {!isLoading && !results && searchData && (
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Research Failed</h3>
              <button
                onClick={() => {
                  setSearchData(null);
                  setResults(null);
        ...
        <footer className="bg-white border-t border-gray-200 mt-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="text-center text-gray-600">
              <p>&copy; 2025 Job Research AI Agent. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </div>
